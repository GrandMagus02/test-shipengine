...
Revision ID: 5622ebae5cca
Revises:
Create Date: 2026-01-20 15:23:08.807227
...
def upgrade() -> None:
    ...
    op.create_unique_constraint(None, "warehouse", ["id"])
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "uuid", name=op.f("post_uuid_key"), postgresql_include=[], postgresql_nulls_not_distinct=False
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "name", name=op.f("rate_limit_name_key"), postgresql_include=[], postgresql_nulls_not_distinct=False
        ),
    )
