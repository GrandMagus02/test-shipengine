...
class Address(Base):
    ...
    address_line3: Mapped[str | None] = mapped_column(String(255), default=None)
    address_residential_indicator: Mapped[ResidentialIndicator] = mapped_column(
        Enum(ResidentialIndicator), default=ResidentialIndicator.UNKNOWN
    )
